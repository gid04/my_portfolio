            ...
            >
                <div className={styles.links}>
                    ...
                    <a href="#about" className={styles.link} title="About">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="4"></circle><path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-3.92 7.94"></path></svg>
                        <span className={styles.label}>About</span>
                    </a>
                    <a href="#experience" className={styles.link} title="Exp">
                    ...
                    <a href="#projects" className={styles.link} title="Work">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>
                        <span className={styles.label}>Work</span>
                    </a>
                    <a href="#contact" className={styles.link} title="Contact">
                ...
                <button onClick={toggleTheme} className={styles.themeToggle} title="Switch Theme">
                    {theme === 'dark' ? (
